...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[234,1652,232,208],[646,1793,51,64],[594,1793,50,91],[468,1260,232,208],[468,420,232,208],[0,1232,232,208],[302,210,232,208],[0,1652,232,208],[468,1470,232,208],[0,812,232,208],[0,602,232,208],[468,630,232,208],[234,1232,232,208],[536,210,232,208],[234,812,232,208],[234,1442,232,208],[536,0,232,208],[468,840,232,208],[468,1050,232,208],[234,602,232,208],[0,1442,232,208],[0,1022,232,208],[302,0,232,208],[234,1022,232,208],[0,0,300,600],[594,1680,106,111],[468,1680,124,362],[302,420,129,163]]}
];
...
(lib.simple_halfpagebannerinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(42).call(this.frame_42).wait(187).call(this.frame_229).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_main).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},9).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({x:150},0).to({scaleX:0.29,scaleY:0.29,y:42.1,alpha:1},6,cjs.Ease.get(1)).to({regX:0.2,regY:17.7,scaleX:0.27,scaleY:0.27,x:150.1,y:41.7},7,cjs.Ease.get(1)).wait(209));

	// party-ready recipes
	this.instance_2 = new lib.partyreadyrecipeshalfbanner();
	this.instance_2.parent = this;
	this.instance_2.setTransform(150,328.4);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(28).to({alpha:1},10).wait(115).to({alpha:0},5).wait(73));

	// fill-your-inbox-with
	this.instance_3 = new lib.fillyourinboxwithhalfbanner();
	this.instance_3.parent = this;
	this.instance_3.setTransform(150,226.8);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(18).to({y:223.8},0).to({alpha:1},10,cjs.Ease.get(1)).wait(203));
	...
	// sign-up
	this.instance_4 = new lib.signuphalfbanner();
	this.instance_4.parent = this;
	this.instance_4.setTransform(150,406.2);
	this.instance_4.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(42).to({y:367.9},0).to({y:411.2,alpha:1},10,cjs.Ease.get(1)).to({y:406.2},8,cjs.Ease.get(1)).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_rollover).wait(42).to({y:367.9},0).to({x:150,y:410.9,alpha:1},10,cjs.Ease.get(1)).to({x:150.1,y:405.9},8,cjs.Ease.get(1)).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:152.8,y:416.1}).wait(42).to({graphics:mask_2_graphics_42,x:152.8,y:416.1}).wait(189));

	// cta-rectangle
	this.instance_5 = new lib.rectanglehalfbanner();
	this.instance_5.parent = this;
	this.instance_5.setTransform(150,405.9);
	this.instance_5.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(42).to({y:367.9},0).to({y:410.9,alpha:1},10,cjs.Ease.get(1)).to({y:405.9},8,cjs.Ease.get(1)).wait(171));

	// diy-tips
	this.instance_6 = new lib.diytipshalfbanner();
	this.instance_6.parent = this;
	this.instance_6.setTransform(150,303.1);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(153).to({alpha:1},10).wait(20).to({alpha:0},5).wait(43));

	// holiday-inspiration
	this.instance_7 = new lib.holidayinspirationhalfbanner();
	this.instance_7.parent = this;
	this.instance_7.setTransform(150,328.4);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(183).to({alpha:1},10).wait(20).to({alpha:0},5).wait(13));

	// something-delicious
	this.instance_8 = new lib.somethingdelicioushalfbanner();
	this.instance_8.parent = this;
	this.instance_8.setTransform(151.2,328.4);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(213).to({alpha:1},10).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(143).to({x:186,y:500.1,alpha:1},0).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(140).to({x:186,y:500.1,alpha:1},0).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(133).to({x:186,y:500.1,alpha:1},0).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(126).to({x:186,y:500.1,alpha:1},0).wait(105));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(122).to({x:186,y:500.1,alpha:1},0).wait(109));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(118).to({alpha:1},0).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(114).to({x:186,alpha:1},0).wait(117));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(110).to({x:186,alpha:1},0).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(106).to({x:186,y:500.1,alpha:1},0).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(102).to({x:186,y:500.1,alpha:1},0).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(98).to({x:186,y:500.1,alpha:1},0).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(94).to({x:185.8,y:500.1,alpha:1},0).wait(137));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(90).to({x:185.8,y:500.1,alpha:1},0).wait(141));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_26}]}).to({state:[{t:this.instance_27}]},86).wait(145));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(82).to({x:185.8,y:500.1,alpha:1},0).wait(149));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(78).to({x:185.8,alpha:1},0).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(74).to({x:185.8,y:500.1,alpha:1},0).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(70).to({x:185.8,alpha:1},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(66).to({alpha:1},0).wait(165));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(62).to({x:185.8,alpha:1},0).wait(169));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(58).to({x:185.8,alpha:1},0).wait(173));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_37).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_38).wait(231));
