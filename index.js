...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[651,630,51,64],[599,630,50,91],[770,0,232,208],[302,0,232,208],[536,210,232,208],[770,210,232,208],[302,420,232,208],[536,420,232,208],[536,0,232,208],[302,210,232,208],[770,420,232,208],[0,602,232,208],[234,630,232,208],[0,0,300,600],[468,630,129,163]]}
];
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(61).to({x:186,y:500.1,alpha:1},0).wait(122));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(58).to({x:186,y:500.1,alpha:1},0).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(51).to({x:186,y:500.1,alpha:1},0).wait(132));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(45).to({x:186,y:500.1,alpha:1},0).wait(138));

	// cookie-sixteen
	this.instance_17 = new lib.halfcookiesixteen();
	this.instance_17.parent = this;
	this.instance_17.setTransform(184,499.9);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(39).to({x:186,alpha:1},0).wait(144));

	// cookie-thirteen
	this.instance_18 = new lib.halfcookiethirteen();
	this.instance_18.parent = this;
	this.instance_18.setTransform(184,499.9);
	this.instance_18.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(33).to({x:186,y:500.1,alpha:1},0).wait(150));

	// cookie-ten
	this.instance_19 = new lib.halfcookieten();
	this.instance_19.parent = this;
	this.instance_19.setTransform(184,499.9);
	this.instance_19.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(27).to({x:185.8,y:500.1,alpha:1},0).wait(156));

	// cookie-seven
	this.instance_20 = new lib.halfcookieseven();
	this.instance_20.parent = this;
	this.instance_20.setTransform(184,499.9);
	this.instance_20.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(21).to({x:185.8,alpha:1},0).wait(162));

	// cookie-four
	this.instance_21 = new lib.halfcookiefour();
	this.instance_21.parent = this;
	this.instance_21.setTransform(185.8,499.9);
	this.instance_21.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(15).to({alpha:1},0).wait(168));

	// cookie-two
	this.instance_22 = new lib.halfcookietwo();
	this.instance_22.parent = this;
	this.instance_22.setTransform(184,499.9);
	this.instance_22.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(9).to({x:185.8},0).to({alpha:1},10).wait(164));

	// cookie-one
	this.instance_23 = new lib.halfpagecookieone();
	this.instance_23.parent = this;
	this.instance_23.setTransform(185.8,499.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(183));

	// table
	this.instance_24 = new lib.halfbannertable_1();
	this.instance_24.parent = this;
	this.instance_24.setTransform(150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(183));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.5,299.5,302.3,604.4);
// library properties:
lib.properties = {
